...
BACKUP_DIR="/home/preprodsyncezy/backup/daily"

# Set the name for the backup SQL file
BACKUP_FILE="${CURRENT_DATE}_daily_bu.gzip"

# Get all backup files
TOTAL_BACKUP_FILES=(${BACKUP_DIR}/*.gzip)

# Log files
ACCESS_LOG_FILE="/home/preprodsyncezy/backup/access_logs.log"
ERROR_LOG_FILE="/home/preprodsyncezy/backup/error_logs.log"
REMOVE_BACKUP_FILE="/home/preprodsyncezy/backup/daily_removed_backup.log"
...
# Check if there are more than 7 backups
if [ "${#TOTAL_BACKUP_FILES[@]}" -gt 7 ]; then
